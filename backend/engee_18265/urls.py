...
admin.site.site_header = "engee"
admin.site.site_title = "engee Admin Portal"
admin.site.index_title = "engee Admin"
...
schema_view = get_schema_view(
    openapi.Info(
        title="engee API",
        default_version="v1",
        description="API documentation for engee App",
    ),
    public=True,
